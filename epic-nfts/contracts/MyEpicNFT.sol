...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["DJ", "Jade", "thx", "f**k", "*uc*", "ariana"];
  string[] secondWords = ["DJ", "Jade", "thx", "f**k", "*uc*", "ariana"];
  string[] thirdWords = ["DJ", "Jade", "thx", "f**k", "*uc*", "ariana"];
